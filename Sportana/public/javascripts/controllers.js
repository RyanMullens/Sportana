...
app.controller("ViewProfileController", function($http, $stateParams){
	...
	*/
	...
	user.user = "rmullens";
	user.firstName = "Ryan";
	user.lastName = "Mullens";
	user.dateOfBirth = "02-27-1994";
	user.city = "Holliston"
	user.favoriteSports = [{"sportName":"Frisbee","sportImage":"/images/icon_73766"}
	...
	console.log("meep " + JSON.stringify($stateParams));
